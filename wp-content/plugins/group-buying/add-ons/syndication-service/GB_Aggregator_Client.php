...
class GB_Aggregator_Client extends GB_Aggregator_Plugin {
	...
	public function request( $url, $args = array() ) {
		...
		// Logging
		do_action( 'gb_log', __CLASS__ . '::' . __FUNCTION__ . ' - GB_Aggregator_Client::request() URL', $url );
		do_action( 'gb_log', __CLASS__ . '::' . __FUNCTION__ . ' - GB_Aggregator_Client::request() Args', $args );
		do_action( 'gb_log', __CLASS__ . '::' . __FUNCTION__ . ' - GB_Aggregator_Client::request() Response', $this->response );
	...
	private function get_headers() {
		$headers = array(
			...
			'x-gbs-url' => home_url(),
			'x-gbs-plugin' => Group_Buying_Update_Check::PLUGIN_NAME,

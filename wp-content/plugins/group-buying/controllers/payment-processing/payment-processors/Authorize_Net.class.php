...
class Group_Buying_Authorize_Net extends Group_Buying_Credit_Card_Processors {
	...
	public function process_payment( Group_Buying_Checkouts $checkout, Group_Buying_Purchase $purchase ) {
		...
		do_action( 'gb_log', __CLASS__ . '::' . __FUNCTION__ . ' - Authorize Net Response', $post_data );
		...
		do_action( 'gb_log', __CLASS__ . '::' . __FUNCTION__ . ' - post_string', $post_string );
		...
		do_action( 'gb_log', __CLASS__ . '::' . __FUNCTION__ . ' - Authorize Net Response', $response );
	...
	public function process_api_payment( Group_Buying_Purchase $purchase, $cc_data, $amount, $cart, $billing_address, $shipping_address, $data ) {
		...
		do_action( 'gb_log', __CLASS__ . '::' . __FUNCTION__ . ' - Authorize Net Response', $aim_data );
	...
	private function set_error_messages( $response, $display = TRUE ) {
		if ( $display ) {
			...
			do_action( 'gb_error', __CLASS__ . '::' . __FUNCTION__ . ' - Auth.net Error Response', $response );
		}
	}

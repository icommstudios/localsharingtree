...
class Group_Buying_Featured_Content extends SEC_Controller {
	...
	public static function register_meta_boxes() {
		// Deal specific
		$args = array(
				'gb_deal_theme_meta' => array(
						'title' => 'Theme Options',
						'show_callback' => array( __CLASS__, 'show_meta_box_gb_theme_meta' ),
						'save_callback' => array( __CLASS__, 'save_meta_box_gb_theme_meta' ),
						'weight' => 10
					)
			);
	...
	public static function show_meta_box_gb_theme_meta( Group_Buying_Deal $offer, $post, $metabox ) {
		$featured_content = self::get_featured_content( $post->ID );
		include 'views/meta_box.php';
	}

	public static function save_meta_box_gb_theme_meta( Group_Buying_Deal $offer, $post_id, $post ) {

	...
	function gb_get_header_logo( $location = null, $term_logo_url = null ) {
		...
		if ( isset( $term_logo_url ) && $term_logo_url != '' ) {
			...
			if ( !file_exists( $system_img_url )) {
				$img_url = get_bloginfo( 'template_directory' ) . "/assets/img/logo.png";	
			}
		}

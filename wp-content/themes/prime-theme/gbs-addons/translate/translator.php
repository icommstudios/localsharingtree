...
if ( class_exists( 'SEC_Controller' ) ) {
	...
	class Group_Buying_Translator extends SEC_Controller {
		const SETTINGS_PAGE = 'translation';
		...
		public static function register_options() {
			...
			$args = array(
				...
				'title' => self::__( 'SeC Translator' ),
				'menu_title' => self::__( 'Translator' ),
				'weight' => PHP_INT_MAX-95,
				'reset' => FALSE, 
				'section' => 'theme'
				);
			...
			$settings = array(
				'gb_addons' => array(
					'callback' => array( get_class(), 'display_translator_selection' ),
					'settings' => array(
						self::TRANSLATION_OPTION => array(
							'option' => array( 
								'type' => 'bypass',
								'description' => self::__( 'View the help section to learn more about this tool.' )
								 )
							)
						)
					)
...
?>
		...
		public static function options_help_section() {
			...
			$screen->add_help_tab( array(
					...
					'content' =>
					'<p><strong>' . self::__( 'Translate or convert any text generated by SeC .' ) . '</strong></p>' .
			...
			$screen->add_help_tab( array(
					...
					'title'   => self::__( 'Translating SeC ' ),
					'content' =>
					'<p><strong>' . self::__( 'How do I translate SeC ?' ) . '</strong></p>' .
					'<p>' . sprintf( self::__( 'Instructions on how to translate SeC can be found <a href="%s">here</a>.' ), 'http://groupbuyingsite.com/forum/showthread.php?1714-Translating-GBS' ) . '</p>'
				) );
		}
...
add_action( 'init', array( 'Group_Buying_Translator', 'init' ), 5  );

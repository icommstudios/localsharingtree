		...
		<div id="coupon-wrap" class="clearfix">
			<div id="voucher-top" class="clearfix">
				...
				<div id="deal" class="clearfix">
                	<div class="clearfix"><p class="title" style="font-size: larger;"><?php gb_merchant_name( gb_get_merchant_id(gb_get_vouchers_deal_id()) ); ?></p></div>
					<div class="clearfix">
						<p class="title">
                    ...
                    <div class="clearfix">
                    	<div id="colomn-left" class="left">
                            <p class="title">
                                <?php gb_e( 'Deal Price:' ); ?>
                            </p><span class="value"><?php gb_formatted_money( gb_get_price( gb_get_vouchers_deal_id() ) ); ?></span>
                            
						</div>
                        <div id="colomn-right" class="right">
                             <p class="title">
                                <?php gb_e( 'Original Price:' ); ?>
                            </p><span class="value"><?php gb_formatted_money( gb_get_deal_worth( gb_get_vouchers_deal_id() ) ); ?></span>
                        </div>
                         <div class="clearfix" style="clear: both;">
                         	 <p class="title" style="margin-top: 0; padding-top: 15px;">
                                 <?php gb_e( 'Description:' ); ?>
                            </p>
                            <span class="value"><?php gb_rss_excerpt( gb_get_vouchers_deal_id() ); ?></span>
                         </div>
					</div>
					<div id="colomn-left" class="left">
                    	<p class="title">
						...
						<p class="title">
							<?php gb_e( 'Expires On:' ); ?>
						</p><span class="value"><?php gb_voucher_expiration_date(get_the_ID()); ?></span>
						<p class="title">
							<?php gb_e( 'Fine Print:' ); ?>
            ...
            <div class="small_font clearfix">
				<?php echo sprintf( gb__( 'This certificate was purchased on LocalSharingTree.com. The buyer paid %s for %s.' ), gb_get_formatted_money( gb_get_price( gb_get_vouchers_deal_id() ) ), str_replace( gb__( 'Voucher for' ), '', get_the_title() ) );  ?>
			</div>
		</div>

							...
							<table class="purchase_table vouchers_table gb_table purchases">
								...
								<tbody>
									<?php foreach ( $vouchers as $voucher_id ): ?>
										<tr>
											<?php if ( !gb_is_voucher_active( $voucher_id ) ): ?>
												<td colspan="4">
													<?php gb_e('Pending') ?>
												</td>
											<?php else: ?>
												...
												<td class="va-middle">
													...
													<?php elseif ( gb_is_voucher_active( $voucher_id ) ): ?>
														<a href="<?php gb_voucher_permalink( $voucher_id, TRUE ) ?>" title="<?php gb_e( 'Download Voucher' ) ?>" class="button voucher_download"><?php gb_e( 'Download Voucher' ) ?></a>
													<?php else: ?>
														<span class="clearfix">

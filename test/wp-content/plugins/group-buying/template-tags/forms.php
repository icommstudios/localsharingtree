	...
	<?php elseif ( $data['type'] == 'radios' ): ?>
		<?php foreach ( $data['options'] as $option_key => $option_label ): ?>
			<span class="gb-form-field-radio">
				<label for="gb_<?php echo $category; ?>_<?php echo $key; ?>_<?php esc_attr_e( $option_key ); ?>"><input type="radio" name="gb_<?php echo $category; ?>_<?php echo $key; ?>" id="gb_<?php echo $category; ?>_<?php echo $key; ?>_<?php esc_attr_e( $option_key ); ?>" value="<?php esc_attr_e( $option_key ); ?>" <?php checked( $option_key, $data['default'] ) ?> />&nbsp;<?php _e( $option_label ); ?></label>
			</span>
		<?php endforeach; ?>

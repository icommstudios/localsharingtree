...
class Group_Buying_Purchase extends Group_Buying_Post_Type {
	...
	public static function new_purchase( $args = array() ) {
		...
		do_action( 'gb_log', __CLASS__ . '::' . __FUNCTION__ . ' - new purchase', $purchase );
		do_action( 'gb_new_purchase', $purchase, $args );
		do_action( 'gb_log', __CLASS__ . '::' . __FUNCTION__ . ' - new purchase after action', $purchase );
		return $id;
	}
	...
	public function set_total( $total ) {
		// FUTURE Explore the removal  of shipping and tax from the set above
		$this->save_post_meta( array(

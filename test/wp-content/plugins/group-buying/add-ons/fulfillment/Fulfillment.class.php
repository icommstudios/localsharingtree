...
class Group_Buying_Fulfillment extends Group_Buying_Controller {
	...
	public static function enqueue_scripts() {
		...
		$done = TRUE;
		wp_register_script('gbs_admin_fulfillment', GB_URL.'/resources/js/admin/fulfillment.admin.gbs.js', array('jquery'), Group_Buying::GB_VERSION, TRUE);
		wp_enqueue_script( 'gbs_admin_fulfillment' );
	}
}

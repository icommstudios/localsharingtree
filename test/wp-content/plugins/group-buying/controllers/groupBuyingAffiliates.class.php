...
class Group_Buying_Affiliates extends Group_Buying_Controller {
	...
	public static function affiliate_record( $account, $purchaser_account, $payment_id, $credits, $type ) {
		...
		Group_Buying_Records::new_record( sprintf( self::__( '%s Points from %s (#%s)' ), ucfirst( $type ), $purchaser_name, $purchaser_id ), Group_Buying_Accounts::$record_type . '_' . $type, sprintf( self::__( '%s Points from %s (#%s)' ), ucfirst( $type ), $purchaser_name, $purchaser_id ), 1, $account_id, $data );
	}

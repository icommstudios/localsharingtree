...
class Group_Buying_Records extends Group_Buying_Controller {
	...
	public static function affiliate_record( $account, $payment_id, $credits, $type ) {
		...
		Group_Buying_Records::new_record( sprintf( self::__( '%s Credit Applied' ), ucfirst( $type ) ), Group_Buying_Accounts::$record_type . '_' . $type, sprintf( self::__( '%s Credit Applied' ), ucfirst( $type ) ), 1, $account_id, $data );
	}

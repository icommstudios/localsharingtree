...
class Group_Buying_Addons extends Group_Buying_Controller {
	...
	private static function addon_definitions() {
		...
		self::$addons['gbs_importer_framework'] = array(
			...
			'files' => array(
				GB_PATH.'/controllers/importer/GBS_Importer_Framework.php',
				GB_PATH.'/controllers/importer/GBS_Importer_Deal.php',
				GB_PATH.'/controllers/importer/GBS_Importer_API.php',
			),
			'callbacks' => array(

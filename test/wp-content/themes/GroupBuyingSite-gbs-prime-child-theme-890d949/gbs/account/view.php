	...
	<div class="dash_section">
		...
		<?php
			...
			if ($vouchers->have_posts()) {
					...
					while ($vouchers->have_posts()) : $vouchers->the_post();
						...
						<tr>
							...
							<td class="td_voucher">
								...
								<?php else: ?>
									<?php echo '<a href="'.gb_get_voucher_permalink( get_the_ID() ).'" title="'.gb__( 'Download Voucher' ).'" class="alt_button voucher_download">'.gb__( 'Download Voucher' ).'</a>'; ?>
								<?php endif ?>
							</td>
							</td>
							<td class="td_expires">
				...
				<h4 class="alert">If your voucher has been redeemed in error, <a href="http://localsharingtree.com/contact/">please click here to contact our Support Team.</a> </h4>

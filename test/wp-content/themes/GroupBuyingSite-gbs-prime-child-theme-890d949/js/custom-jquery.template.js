...
jQuery(window).load(function() {
    ...
    //trigger
    if (jQuery('#trigger_fancybox_message_banner').children('.gb-message').length > 0) {
        ...
        //show it
        jQuery('#trigger_fancybox_message_banner').trigger('click');
...
sprout.ready = function($) {
    ...
    jQuery('.header-locations-drop-link').click(function() {
        jQuery('#locations_header_wrap').slideToggle(300);
    });
    ...
    $("#nav_subscription select").mouseout(function(e) {
        e.stopPropagation();
    });
    ...
    jQuery(function() {
        jQuery('.location-item a').click(function(e) {
            ...
            jQuery.cookie('gb_location_preference', location_slug, {
                path: '/',
                expires: date
            });
        });

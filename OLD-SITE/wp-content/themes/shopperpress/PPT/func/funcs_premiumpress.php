...
function PPTFormatTime($date){

global $post, $wpdb;

$date_format = get_option('date_format') . ' ' . get_option('time_format');
$date = mysql2date($date_format, $date, false); 
...
$TAXARRAY = array();
	...
	if($type =="posts"){
		...
		$my_post['comment_status'] 		= (isset($line[array_search('comment_status', $titles)]) && array_search('comment_status', $titles) != 0 ? $line[array_search('comment_status', $titles)] : "open");

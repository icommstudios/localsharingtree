...
*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-**-*-*-*-*-*-*-*-*-*-*-*-*-*/	
    ...
    #
    {
		...
		if (!$this->image) { if ($this->debug) { return false;}else{return false; }};
...
*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-**-*-*-*-*-*-*-*-*-*-*-*-*-*/		
	...
	#			
	{
		...
		if (count($this->captionBoxPositionArray) == 4) {
			...
			if ($this->debug) { return false; }else{ return false; }
		}
...
## --------------------------------------------------------	
	...
	#				third party class to save as bmp.
    {
		...
		if (!is_resource($this->imageResized)) { if ($this->debug) { return false; }else{return false; }}			

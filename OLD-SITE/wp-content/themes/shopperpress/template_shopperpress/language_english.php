...
"english" => array(
	...
	"myaccount" => array(
		...
		"41" 			=> "Select My Photo",
		"42" 			=> "Select Non Profit Organization",
		"43" 			=> "The mission of Local School Deals is to strengthen communities. Local School Deals will donate 10% of your purchases to the school or non-profit organization of your choice. Simply choose from the list below to let us know which school or organization you would like to help. Remember, your choice will stay the same for future purchases unless you change it.",		
	...
	"validate" => array(
		...
		"23"		=> "Please select a organization to continue.",		
	),
	...
	"object" => array(
 	...
 	"sp" => array(
		...
		"8" 					=> "in stock",
		"9" 					=> "Checkout Now",
		"10" 					=> "Would you like to update your basket now?",
		"11" 					=> "out of stock",	 
		"12" 					=> "VAT Saving",
		"13" 					=> "Promotional Discount",
		"14" 					=> "Shopping Basket",
		"15" 					=> "Coupon/Discount Code",
		"16" 					=> "Now",
		"17" 					=> "Empty Cart",
		"18" 					=> "Continue Shopping",
		"19" 					=> "Coupon Accepted",
		"20" 					=> "Invalid Coupon Code",		
		"21" 					=> "Contact Information",		
		"22" 					=> "Personal Details",				
		"23" 					=> "Your Address",		
		"24" 					=> "Tick this box if you have a separate shipping address.",
		"25" 					=> "Shipping Address",
		"26" 					=> "Payment Method",		
		"27" 					=> "Shipping Methods",		 		
		"28" 					=> "Please select the preferred shipping method to use on this order.",  
		"29" 					=> "Please select the preferred payment method to use on this order.",
		"30" 					=> "Add Comments About Your Order",	

		"31" 					=> "Order Confirmation",	
		"32" 					=> "Please check and confirm your details below;",	
		"33" 					=> "Your Details",	
		"34" 					=> "Tel.",	
		"35" 					=> "Email",	
		"36" 					=> "Delivery Details",	
		"37" 					=> "Comments",	
		"38" 					=> "Same as your details",	
		"39" 					=> "Total Now Due",	
		"40" 					=> "There is an addition shipping charge of %a delivery to %b",
			
		"41" 					=> "Please select the preferred shipping method to use on this order.",
		"42" 					=> "Order ID",
		"43" 					=> "Your shopping cart is empty!",
		
		"44" 					=> "Account Information",
		"45" 					=> "Existing Customer Login",
		
		"46" 					=> "Not yet a member?",
		"47" 					=> "Registered users can login at a later date to check the status of their orders, change preferences, and expedite future purchases.", 
		"48" 					=> "Guest Checkout",
		
		"49" 					=> "No payment is due on this order",
		"50" 					=> "Attached File",	
					
		 
		"_side2" 				=> "sorry, we are out of stock",
		"_side3" 				=> "Attach a file",
		"_side4" 				=> "save file",
		"_side5" 				=> "add to cart",
		"_side6" 				=> "buy now", 
		 
		"_side8" 				=> "you have already paid for this download, clicking download again will not cost you any more money.",
		 
		"_side10" 				=> "The file has been attached successfully!",
		"_side11" 				=> "There was an error during file upload!",
		"_side12" 				=> "Attach a file",
		"_side13" 				=> "This download will cost you %a, are you sure you want to continue?",
		"_side14" 				=> "You do not have enough credits to purchase this item. Please update your account.",
		
		
		"_tpl_myaccount40" 		=> "Your current balance is",
		"_tpl_myaccount41" 		=> "Deposit Money",
		"_tpl_myaccount42" 		=> "Here you can deposit money to your account",
		"_tpl_myaccount43" 		=> "Withdraw Money",
		"_tpl_myaccount44" 		=> "Here you can withdraw your money",
		"_tpl_myaccount45" 		=> "Deposit Money",
		"_tpl_myaccount46" 		=> "How much would you like to deposit?",
		 
		"_tpl_myaccount48" 		=> "How Do You Want to Pay?",
		"_tpl_myaccount49" 		=> "You will be transferred to a secure payment page. After payment your money will added to your account.",
		...
		"eb4" 				=> "Buy Now",
		"eb5" 				=> "Buy Now",	
		"51" 					=> "Select Organization",
		"52" 					=> "The mission of Local School Deals is to strengthen communities. Local School Deals will donate 10% of your purchases to the school or non-profit organization of your choice. Simply choose from the list below to let us know which school or organization you would like to help. Remember, your choice will stay the same for future purchases unless you change it.",
